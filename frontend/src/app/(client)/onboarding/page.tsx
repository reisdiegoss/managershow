            ...
            <Card className="w-full max-w-3xl bg-slate-900/40 backdrop-blur-xl border-slate-800 shadow-2xl relative z-10">
                <CardHeader className="text-center pb-8 border-b border-slate-800/50 mb-6">
                    ...
                    <CardDescription className="text-slate-400 text-lg">
                        Poucos passos nos separam de profissionalizar a gestão da sua Agência.
                    </CardDescription>
                        ...
                        <div className="space-y-6 animate-in fade-in slide-in-from-right-4">
                            <div className="p-4 rounded-xl bg-yellow-500/10 border border-yellow-500/20 mb-6">
                                ...
                                <p className="text-sm text-slate-400 leading-relaxed mb-4">
                                    Com a trava ativa, nenhum pagamento na estrada poderá ser liberado e nenhum checklist do Day Sheet avança enquanto o status do Show não for "CONTRATO ASSINADO". Fortalece a segurança da agência.
                                </p>
                            ...
                            <div>
                                <Label className="text-slate-300">Taxa Padrão da Agência do Contrato (%)</Label>
                                <Input
                                    type="number"
