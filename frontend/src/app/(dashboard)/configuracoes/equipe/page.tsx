        ...
        <div className="flex h-full flex-col gap-6 w-full animate-in fade-in duration-500">
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-slate-400 font-medium">Gestão de acessos, permissões e configurações do seu perfil de usuário.</p>
                </div>
            </div>
            ...
            <div className="w-full h-full rounded-xl border border-slate-800 bg-slate-900/50 backdrop-blur-sm p-6 mt-4 flex justify-center pb-24">
                {/* Clerk Integrado Nativo com Dark Mode Theme já configurado globalmente no Provider */}
                <UserProfile />
            </div>
        </div>
    );
